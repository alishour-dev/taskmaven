					...
					<Sheet>
						...
						<SheetContent className='sm:max-w-xs' side='left'>
							<nav className='grid gap-6 text-lg font-medium'>
								...
								<Link className='text-muted-foreground hover:text-foreground flex items-center gap-4 px-2.5' href='#'>
									<Home className='h-5 w-5' />
									Dashboard
								</Link>
								<Link className='text-muted-foreground hover:text-foreground flex items-center gap-4 px-2.5' href='#'>
								...
								<Link className='text-foreground flex items-center gap-4 px-2.5' href='#'>
									<Package className='h-5 w-5' />
									Products
								</Link>
								<Link className='text-muted-foreground hover:text-foreground flex items-center gap-4 px-2.5' href='#'>
